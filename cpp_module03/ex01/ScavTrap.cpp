...
/*   Updated: 2023/02/05 15:58:32 by hyujung          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string & target){
    ...
    {
        std::cout << "target : " << target << " does not exist. [ScavTrap]" << std::endl;
        std::cout << "------------------------------------------------" << std::endl;  return ;
    }
    if (this->energy <= 0)
    {
        print_red(this->name + " can't attack. There is no energy available [ScavTrap]");
        std::cout << std::endl;
        std::cout << "------------------------------------------------" << std::endl;
        return ;
    }
    ...
    {
        std::cout << this->name << " attack failed. Remaining energy : " << this->energy << " [ScavTrap]"<< std::endl;
    }
    else
    {
        this->energy--;
        ...
        << target << ", causing "\
        << this->attackDamage << " points of damage! Remaining energy : " << this->energy << " [ScavTrap]" <<std::endl;
    }
...
void ScavTrap::guardGate(){
    if (this->hit <= 0)
    {
        print_red(this->name + " can't enter gate keeping Mode cuz dead!.");
        return ;
    }
