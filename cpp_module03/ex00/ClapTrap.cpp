...
/*   Updated: 2023/02/05 15:14:26 by hyujung          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ClapTrap::getHit(void) const {return (this->hit);}

int ClapTrap::getEnergy(void) const {return (this->energy);}
...
void ClapTrap::attack(const std::string & target){
    ...
    if (this->energy <= 0)
    {
        std::cout << this->name << " can't attack. There is no energy available" << std::endl;
        std::cout << "------------------------------------------------" << std::endl;
        return ;
    }
...
void ClapTrap::setAttackDamage(int const amount){
    if (amount < 0)
    {
        std::cout << "AttackDamage needs to be positive  number" << std::endl; return ;
    }
    std::stringstream sstm;
    sstm << this->name << " : " << this->attackDamage << " --> " << amount;
    std::cout << std::endl;
    print_yellow("Setting attackDamage for ");
